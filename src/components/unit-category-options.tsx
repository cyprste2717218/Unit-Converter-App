...
import { UnitCategoryOptionsType, OptionType, UnitsType } from '../types/unitCategoryOptionsTypes';
...
const UnitCategoryOptions = ({categoryValue, setCategoryValue, setCurrentUnits}: UnitCategoryOptionsType): JSX.Element => {
    ...
    const UnitOption = ({option}: {option: OptionType}) => {
        return (
            <Col className='unit-option' onClick={() => handleClick(option)}
    ...
    const options: OptionType[] = [
      ...
      const units: UnitsType = {
        'Temperature': ['Celsius', 'Farenheit', 'Kelvin'],
          'Length': ['Meter', 'Kilometer', 'Centimeter', 'Millimeter', 'Inch', 'Foot', 'Yard', 'Mile', 'Nanometre', 'Nautical Mile'],
        'Area': ['Square Metre', 'Square Kilometer', 'Square Inch', 'Square Foot', 'Square Yard', 'Square Mile', 'Acre', 'Hectare'],
          'Weight': ['Miligram', 'Gram', 'Kilogram', 'Tonne', 'Ounce', 'Pound', 'Stone', 'US Ton', 'Imperial Ton'],
